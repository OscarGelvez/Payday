 ...
 * commonly needed functionality with the goals of having a very small footprint.</div>
 *
...
//
// This sandboxing technique is not perfect and doesn't aim to be. The goals is to prevent exploits
 ...
 *
 * @example
 * Here is a simple form for editing user contacts information. Adding, removing, clearing, and
 ...
 *      Contact:
 *      <ul>
 *        <li ng-repeat="contacts in settings.contacts">
 *          <select ng-model="contacts.type">
 *             <option>phone</option>
 *             <option>email</option>
 *          </select>
 *          <input type="text" ng-model="contacts.value"/>
 *          [ <a href="" ng-click="settings.clearContact(contacts)">clear</a>
 *          | <a href="" ng-click="settings.removeContact(contacts)">X</a> ]
 *        </li>
 ...
 *    };
 *
 *    SettingsController1.prototype.clearContact = function(contacts) {
 *      contacts.type = 'phone';
 *      contacts.value = '';
 *    };
 *   </file>
 ...
 *
 *       var firstRepeat =
 *           container.element(by.repeater('contacts in settings.contacts').row(0));
 *       var secondRepeat =
 *           container.element(by.repeater('contacts in settings.contacts').row(1));
 *
 *       expect(firstRepeat.element(by.model('contacts.value')).getAttribute('value'))
 *           .toBe('408 555 1212');
 *
 *       expect(secondRepeat.element(by.model('contacts.value')).getAttribute('value'))
 ...
 *
 *       expect(container.element(by.repeater('contacts in settings.contacts').row(2))
 *           .element(by.model('contacts.value'))
 *           .getAttribute('value'))
 ...
 *     Contact:
 *     <ul>
 *       <li ng-repeat="contacts in contacts">
 *         <select ng-model="contacts.type">
 *            <option>phone</option>
 *            <option>email</option>
 *         </select>
 *         <input type="text" ng-model="contacts.value"/>
 *         [ <a href="" ng-click="clearContact(contacts)">clear</a>
 *         | <a href="" ng-click="removeContact(contacts)">X</a> ]
 *       </li>
 ...
 *
 *      var firstRepeat =
 *          container.element(by.repeater('contacts in contacts').row(0));
 *      var secondRepeat =
 *          container.element(by.repeater('contacts in contacts').row(1));
 *
 *      expect(firstRepeat.element(by.model('contacts.value')).getAttribute('value'))
 *          .toBe('408 555 1212');
 *      expect(secondRepeat.element(by.model('contacts.value')).getAttribute('value'))
 ...
 *      container.element(by.linkText('add')).click();
 *
 *      expect(container.element(by.repeater('contacts in contacts').row(2))
 *          .element(by.model('contacts.value'))
 *          .getAttribute('value'))
 *          .toBe('yourname@example.org');
 *    });
