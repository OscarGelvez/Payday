    ...
    function ($stateProvider,  $urlRouterProvider, $translateProvider) {
        ...
        $stateProvider.
                ...
                state('home',{
                    ...
                    templateUrl: '..'+folderProject+'/home.html',
                    controller: 'HomeController'
                }).
                state('home.newLoan',{
                    url : '/loan/new',
                    templateUrl : '..'+folderProject+'/html/loans/new.html',
                    controller : 'LoanController'
                }).
                state('home.paymentPlan',{
                    url : '/loan/payment/plan',
                    templateUrl : '..'+folderProject+'/html/loans/paymentPlan.html',
                    controller : 'LoanController'
                }).
                state('home.collectionDay',{
                    url : '/loan/list/day',
                    templateUrl : '..'+folderProject+'/html/loans/collectionDay.html',
                    controller : 'LoanController'
                }).
                state('home.asignRoutePosition',{
                    url : '/loan/new/asignPosition',
                    templateUrl : '..'+folderProject+'/html/loans/asignRoutePosition.html',
                    controller : 'LoanController'
                }).
                state('home.addPayment',{
                    url : '/loan/add/payment',
                    templateUrl : '..'+folderProject+'/html/loans/addPayment.html',
                    controller : 'LoanController'
                }).
                state('home.listPaymentsLoan',{
                    url : '/loan/view/payments',
                    templateUrl : '..'+folderProject+'/html/loans/paymentsHistory.html',
                    controller : 'LoanController'
                }).
                state('home.detailLoan',{
                    url : '/loan/detail/',
                    templateUrl : '..'+folderProject+'/html/loans/detail.html',
                    controller : 'LoanController'
                }).
                state('home.stateFeesLoan',{
                    url : '/loan/:loan_id/state/fees',
                    templateUrl : '..'+folderProject+'/html/loans/stateFees.html',
                    controller : 'LoanController'
                }).
                state('home.simulate',{
                    url : '/loan/demo',
                    templateUrl : '..'+folderProject+'/html/demo/index.html',
                    controller : 'LoanController'
                }).
                state('home.movesAdd',{
                    url : '/moves/add',
                    templateUrl :   '..'+folderProject+'/html/moves/add.html',
                    controller : 'MoveController'
                }).
                state('home.movesList',{
                    url : '/moves/list',
                    templateUrl :   '..'+folderProject+'/html/moves/list.html',
                    controller : 'MoveController'
                }).
                state('home.reports',{
                    url : '/reports/',
                    templateUrl : '..'+folderProject+'/html/reports/index.html',
                    controller : 'ReportController'                            
                }).
                state('home.movesOfDay',{
                    url : '/reports/movesOfDay',
                    templateUrl : '..'+folderProject+'/html/reports/movesOfDay.html',
                    controller : 'MoveController'
                }).
                state('home.LoansOfDay',{
                    url :   '/reports/loans/day',
                    templateUrl : '..'+folderProject+'/html/reports/loansOfDay.html',
                    controller : 'ReportController'
                }).
                state('home.nextFewToEnd',{
                    url : '/reports/loans/nextFewToEnd',
                    templateUrl : '..'+folderProject+'/html/reports/nextFewToEnd.html',
                    controller : 'ReportController'
                }).
                state('home.creditHistoryClient',{
                    url : '/reports/client/history',
                    templateUrl : '..'+folderProject+'/html/reports/creditHistoryClient.html',
                    controller :  'ReportControlller'
                }).
                state('home.test',{
                    url : '/db',
                    templateUrl : '..'+folderProject+'/html/test/testDB.html',
                    controller : 'TestController'
                }).
                state('home.userTest',{
                    url : '/test',
                    templateUrl : '..'+folderProject+'/html/test/userTest.html',
                    controller : 'TestController'
                }).
                state('home.testServer',{
                    url : '/server',
                    templateUrl : '..'+folderProject+'/html/test/server.html',
                    controller : 'TestController'
                });
