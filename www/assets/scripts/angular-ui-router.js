...
function $StateProvider(   $urlRouterProvider,   $urlMatcherFactory) {
  ...
  var stateBuilder = {
    ...
    parent: function(state) {
      ...
      // would match "contacts.list" but not "contacts"
   ...
   *   views: {
   *     'contacts.list': { controller: 'ListController' },
   *     'contacts.item': { controller: 'ItemController' }
   *   }
   * });
   *
   * // ...
   *
   * $state.go('home');
   * // Auto-populates list and item views with /partials/home/contacts/list.html,
   * // and /partials/home/contacts/item.html, respectively.
   * </pre>
   *
  ...
  function $get(   $rootScope,   $q,   $view,   $injector,   $resolve,   $stateParams,   $urlRouter,   $location,   $urlMatcherFactory) {
     ...
     *
     * - `$state.go('contacts.detail')` - will go to the `contacts.detail` state
     ...
     * app.controller('ctrl', function ($scope, $state) {
     *   $scope.changeState = function () {
     *     $state.transitionTo('contacts.detail');
     *   };
     * });
     * </pre>
     *
     ...
     *
     * // absolute name
     * $state.is('contacts.details.item'); // returns true
 ...
 *         <a ui-sref="contacts.detail({ id: contacts.id })">{{ contacts.name }}</a>
 *     </li>
 * </ul>
 * </pre>
 * 
 ...
 * <ul>
 *     <li ng-repeat="contacts in contacts">
 *         <a href="#/contacts/1" ui-sref="contacts.detail({ id: contacts.id })">Joe</a>
 *     </li>
 *     <li ng-repeat="contacts in contacts">
 *         <a href="#/contacts/2" ui-sref="contacts.detail({ id: contacts.id })">Alice</a>
 *     </li>
 *     <li ng-repeat="contacts in contacts">
 *         <a href="#/contacts/3" ui-sref="contacts.detail({ id: contacts.id })">Bob</a>
 *     </li>
 * </ul>
 *
